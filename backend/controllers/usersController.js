...
export const usersGet = async (req, res, next) => {
  ...
  if (foundUser) {
    ...
    // Now let's populate the employers's "jobs" array - for each id, go across to the "jobs" collection and "fill in" the details of each job with specific selected keys
...
//Update the jobs list in employers page


export const updateJobs = (req, res, next) =>{
